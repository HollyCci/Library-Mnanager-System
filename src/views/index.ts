...
> = {
  'BMapGL_show-info': () => import('./BMapGL/show-info/index.vue'),
  ...
  'analyze-data_book-data': () => import('./analyze-data/book-data/index.vue'),
  'analyze-data_borrow-data': () => import('./analyze-data/borrow-data/index.vue'),
  'analyze-data_stack-data': () => import('./analyze-data/stack-data/index.vue'),
  'analyze-data_user-data': () => import('./analyze-data/user-data/index.vue'),
  ...
  'book_book-create': () => import('./book/book-create/index.vue'),
  'book_book-info': () => import('./book/book-info/index.vue'),
  ...
  'facility_scheduled-tasks': () => import('./facility/scheduled-tasks/index.vue'),
  ...
  'reader_book-info': () => import('./reader/book-info/index.vue'),
  'reader_borrow-detail': () => import('./reader/borrow-detail/index.vue'),
